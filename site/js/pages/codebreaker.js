...
function handleSuccessfulUnlock() {
    ...
    setTimeout(() => {
        // Store the unlocked state and authorized token in sessionStorage
        sessionStorage.setItem("unlockedRedacted", "true");
        alert("Access Granted. You may now return to the terminal.");
        window.location.href = './eli-office.html';
    }, 1500);
}
